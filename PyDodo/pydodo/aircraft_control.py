...
def change_altitude(aircraft_id, altitude=None, flight_level=None, vertical_speed=None):
    ...
    Examples
    --------
    >>> pydodo.aircraft_control.change_altitude('BA1', 100)
    True
    """
...
def change_heading(aircraft_id, heading):
    ...
    Examples
    --------
    >>> pydodo.aircraft_control.change_heading('BA1', 240)
    True
    """
...
def change_speed(aircraft_id, speed):
    ...
    Examples
    --------
    >>> pydodo.aircraft_control.change_speed('BA1', 300)
    True
    """
...
def change_vertical_speed(aircraft_id, vertical_speed):
    ...
    Examples
    --------
    >>> pydodo.aircraft_control.change_vertical_speed('BA1', 50)
    True
    """
